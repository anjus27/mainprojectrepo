...
<div class="container" style="margin-top: 100px">
	...
	<div class="col-md-6 col-md-offset-3" align="center">
		<img src="../img/otp.gif" style="width:300px;"><br><br>
        <label>ENTER YOUR OTP</label>
                <input type="number" class="form-control" id="otp" name="otp" placeholder="Enter Your OTP" style="width:300px;">
		<br>
		<input type="submit"   value="VERIFY" name="submitsn" style="width:300px;"><br><br>
