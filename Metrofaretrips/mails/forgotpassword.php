...
if (isset($_POST['submits'])) {
   ...
   $sql="INSERT INTO `tbl_otp`(`email`, `otp`, `count`,`status`) VALUES ('$e','$pa',3,1) ";
//    print_r($sql);
//    return;
...
$mail = new PHPMailer();
  ...
  $mail->Username = "anjusaji9527@gmail.com";
  $mail->Password = "sajilalitha";
...
<div class="container" style="margin-top: 100px">
	...
	<div class="col-md-6 col-md-offset-3" align="center">
		<img src="img/forgot.png" style="width:60px;"><br><br>
    <h2 class="text-center">Forgot Password?</h2>
     <p>You can reset your password here.</p>
		<input type="email" class="form-control" id="email" name="email" placeholder="Your Email id" style="width:300px;">
		<br>
                <input type="submit"  value="ENTER" name="submits" style="width:300px;background-color:;barder-radius:50px;"><br><br>
