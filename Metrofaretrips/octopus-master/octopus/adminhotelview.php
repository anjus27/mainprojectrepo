...
if(!$_SESSION['lid'])
{
 ...
 $sql    = "SELECT * FROM retailer_hoteladd WHERE lid='78'";
...
<script src="assets/vendor/modernizr/modernizr.js"></script>
	...
	<section class="body">
					...
					<!--	<li>
						...
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@JSOFT.com">
								<span class="name">ANJU SAJI</span>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="adminviewprofile.php"><i class="fa fa-user"></i> My Profile</a>
								</li>
								<li>
									<a role="menuitem" tabindex="-1" href="adminchangepassword.php" ><i class="fa fa-lock"></i> Change Password</a>
								</li>
								<li>
					...
					<div class="nano">
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								...
								<!--	<li>
										<a href="../../colorlib-regform-15/completeprofile.php">
									...
									<li class="nav-parent">
										...
										<!--	<li>
											...
											<li>
												<a href="approverejectadmin1.php">
													 new requests
												</a>
											</li>
											<!--<li>
								...
								<!--	<li class="nav-parent">
									...
									<li class="nav-parent">
										...
										<!--	<li>
											...
											<li class="nav-parent">
												<a href = "adminhotelview.php">Hotels</a>
											<!--	<ul class="nav nav-children">
													<li class="nav-parent">
														<a>Third Level</a>
														<ul class="nav nav-children">
		...
		<!-- <a href="adminhome.php" >Back to home</a> -->
					...
					<table width="682" border="1" align="center" cellpadding="30" cellspacing="30">

					<th height="100">Hotel Name</th>
				    <th >Address</th>
				 <!--  <th>Phone Number</th>
...
while ($row = mysqli_fetch_array($result))
{
	...
	?>
                   ...
                   <tr >
        <td align="center"><input type="text"  name="hotelname" value="<?php echo $row['hotelname'];?>" id="hotelname" required/></td>
		<td align="center"><input type="text" name="address" value="<?php echo $row['address']; ?>" id="address" required/></td>
		<!-- <td><input type="text" name="phonenumber" value="<?php echo $row['phonenumber']; ?>" id="phonenumber" required/></td>       
		 <td><input type="text" name="licensenumber"  value="<?php echo $row['licensenumber']; ?>" id="licensenumber" required/></td>
         <td><input type="text" name="licenseprooff" value="<?php echo $row['licenseprooff'];?>" id="licenseprooff" required/></td> -->
         <td align="center"><input type="text" name="rateing" value="<?php echo $row['rateing']; ?>" id="rateing" required/></td>
	   <td align="center"><img src="../uploads/<?php echo $profilepic;?>" id="profilepic" width="75px"  height="75px" required/></td>
