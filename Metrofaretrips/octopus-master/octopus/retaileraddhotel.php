...
if(isset($_POST['submit']))
	...
	$licensenumber=$_POST['licensenumber'];
	  ...
	  move_uploaded_file($file_tmp,"../../uploads/".$file_name);
		...
		$sql1 = "INSERT INTO `retailer_hoteladd`(`lid`,`rid`,`hotelname`,`address`,`phonenumber`,`ctid`,`licensenumber`,`licenseprooff`,`profilepic`,`rateing`,`status`) VALUES ('$lid','$x','$hotelname','$address','$phonenumber','$city','$licensenumber','$file_name2','$file_name','$rateing',1)";
       echo $result1 = mysqli_query($con, $sql1);
					...
					<div id="userbox" class="userbox">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a role="menuitem" tabindex="-1" href="retailerchangepassword.php" data-lock-screen="true"><i class="fa fa-lock"></i> Change Password</a>
								</li>
								<li>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                    ...
                    <form method="POST" class="cv-form" class="register-form" id="register-form" enctype="multipart/form-data" onsubmit="return"  >
                        ...
                        <tr>
                        <tr><td>
                            <label for="hotelname">Hotel Name :</label></td>
