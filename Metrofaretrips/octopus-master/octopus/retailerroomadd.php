	...
	if(isset($_POST['add']))
	 {
		...
		echo		$sql ="INSERT INTO `room`( `lid`,`type`, `bedding`,`number`) VALUES ('$lid','$room','$bed', '$number')" ;
        ...
        <div id="page-wrapper" >
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="roomstatus.php"><i class="fa fa-dashboard"></i>Rooms Status</a>
                    </li>
					<li>
                        <a  class="active-menu" href="room.php"><i class="fa fa-plus-circle"></i>Add Room</a>
                    </li>
                    <li>
                        <a  href="reatilerroomdelete.php"><i class="fa fa-desktop"></i> Delete Room</a>
                    </li>
