...
table, th, td { 
	...
	<section class="body">
        ...
        <tr>
        <td><input type="text" name="hotelname" value="<?php echo $hotelname;?>" id="hotelname" required/><input type="button" onclick="location.href='roomadd.php?hid=<?php echo $hid;?>'">Add details</a></td>
...
<!--<div class="row">
		...
		<!-- Examples -->
		<script src="assets/javascripts/dashboard/examples.dashboard.js"></script></html>
