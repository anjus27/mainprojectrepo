		...
		<div id="userbox" class="userbox">
			<a href="#" data-toggle="dropdown">
				...
				<div class="profile-info"   data-lock-name="John Doe" data-lock-email="johndoe@JSOFT.com">
					<span class="name">User Home</span>
...
<table align="center" cellspacing="30" cellpadding="30" rules="cols" >
<br>
<th > Hotel name</th>
<th> address</th>
...
<td><input type=button  align="center"
 onclick="window.location.href = '../../bookingform/roombookingnew.php?id=<?php echo $s[0];?>';">Book now...!!!</button> </td>
