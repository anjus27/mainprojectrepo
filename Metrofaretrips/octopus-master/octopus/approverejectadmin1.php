...
<html class="fixed">
    ...
    <body>
        ...
        <table width="682" border="1" align="center" cellpadding="20" cellspacing="10">

<caption>
<h2><font color="#660000">Users</font></h2>
</caption>
<tr bgcolor="#c01e46">
  <td align="center" width="10"><b><font color="#000000">Name</font></b></td>
  <td align="center" width="25" ><b><font color="#000000">Email<br /></font></b></td>
  <td align="center" width="25"><b><font color="#000000">Servicename<br />Name</font></b></td>
  <td align="center" width="25"><b><font color="#000000">servicetype</font></b></td>
  <td align="center" hidden="" width="40"><b><font color="#000000">Licensenumber</font></b></td>
  <td align="center" width="30"><b><font color="#000000">Licenseproof</font></b></td>
  
  <td width="30"><b><font color="#000000">Action&nbsp;</td>
 <!-- <td width="20">&nbsp;</td>
  <td width="20" >&nbsp;</td>-->
 
</tr>
<?php
  $sql="select * from tbl_retailerreg as u, login as l where l.lid=u.lid";
...
<tr>
  ...
  <td align="center"><?php echo $row['servicetype'];?></td>
  <td align="center" hidden=""><?php echo $row['licensenumber'];?></td>
  <td align="center"><img src="../uploads/<?php echo $row['idproof'];?></td>
  ...
  <td><?php if($row["status"]=='1')
		 {
			 ?>
    <a href="adminblock.php?view=2&flag=block&id=<?php echo $row['lid'];?>"><font color="#FF0000">unblock</font></a>
    <?php
		 }
		 else if($row["status"]=='2')
		 {
			 ?>
    <a href="adminblock.php?view=1&id=<?php echo $row['lid'];?>"><font color="#006600">block</font></a>
    <?php } ?></td>
