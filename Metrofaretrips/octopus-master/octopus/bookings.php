...
<?php
$query="select * from book_room inner join tbl_userreg ON book_room.mailid=tbl_userreg.email inner join retailer_hoteladd on retailer_hoteladd.lid =book_room.hid inner join tbl_room on tbl_room.hid=retailer_hoteladd.hid";
