...
$lid=$_SESSION[lid];
//echo $lid;
 $sql    = "SELECT * FROM tbl_retailerreg WHERE lid='$lid'";
  ...
  //  {
	//	$n=$_POST['fname'];
       ...
       //$name=$_POST['firstname'];
        //$dob=$_POST['dob'];
	//	 $sql = "UPDATE `tbl_userreg` SET `firstname`='$n' WHERE lid='$lid'"; 
		 //echo $sql;
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info"   data-lock-name="John Doe" data-lock-email="johndoe@JSOFT.com">
								<span class="name">Retailer Home</span>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a role="menuitem" tabindex="-1" href="retailerchangepassword.php" ><i class="fa fa-lock"></i> Change Password</a>
								</li>
								<li>
			...
			<div class="inner-wrapper">
               ...
               <!-- <table border="2">
                ...
                <td><b><label for="gender">Gender :</label><b></td>
                         <td>   <input type="text" name="gender" value="<?php //echo $gender;?>" id="gender" /></td>
                </td>
                </tr>
              ...
              <td>  <label for="dob">DOB :</label></td>
                ...
                <td><input type="text" name="servicename" value="<?php //echo $servicename;?>" id="servicename" required/></td>
                </td>
                </tr>

                <tr>
                <td>
                <td><label for="servicertype">Service type :</label></td>
                <td><input type="text" name="servicetype" value="<?php //echo $servicetype;?>" id="servicetype" required/></td>
                </td>
                </tr>
                ...
                <td><input type="text" name="city" value="<?php //echo $city;?>" id="city" required/></td>
                </td>
                </tr>
                ...
                <td><input type="text" name="phonenumber" value="<?php //echo $phonenumber;?>" id="phonenumber" required/></td>
                </td>
                </tr>
                ...
                <td><input type="text" name="email" value="<?php //echo $email;?>" id="email" required/></td>
                </td>
                </tr>
                ...
                <td><input type="text" name="idproof" value="<?php //echo $idproof;?>" id="idprrof" required/></td>
                </td>
				   </tr>
                </table>-->
