		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<tr><td><label><b>Bedding Type</b></label>
                                            <select name="bed" class="" required>
												<option value selected ></option>
					...
					<input type="textarea"></td></tr>
                    <tr><td><input type="button" onclick="window.location.href = '#';" value="Check availability"</td></tr>                       
					 </tr>
					 </table>
					 </div>
