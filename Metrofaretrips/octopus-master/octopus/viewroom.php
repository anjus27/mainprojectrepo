...
//$lid=$_GET['lid'];
$_SESSION['lid']=$lid;
$query="select * from book_room where lid='$lid'";
...
?>
					 ...
					 <tr>
					 <tr> <td><b>Hotel</b>	
					 <input type="text" value="<?php echo checkin ;?>" readonly ></td></tr><br>
					<tr> <td><b>Check in date</b>
					 <input type="date" v></td></tr><br>

					<tr> <td><b>Check out date</b>
					<input type="date"></td></tr>
					<tr> <td><b>Type of room</b> <select name="troom"  class="" required>
					...
					<tr><td><b>Number of Adults</b>
					<input type="text"></td></tr>
					<tr><td><b>Number of Children</b>
					<input type="text"></td></tr>
                    <tr><td><input type="button" onclick="window.location.href = '#';" value="Print File"</td></tr>                       
					 </tr>
					 </table>
					 </div>
