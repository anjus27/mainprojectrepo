...
//$id="SELECT `id` FROM `book_room` WHERE `lid`='$lid'";
//$id=$_SESSION['id'];
					...
					<div id="userbox" class="userbox">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="userviewprofile.php"><i class="fa fa-user"></i> My Profile</a>
								</li>
								<li>
									<a role="menuitem" tabindex="-1" href="changepassworduser.php" data-lock-screen="true"><i class="fa fa-lock"></i> Change Password</a>
								</li>
								<li>
								...
								<!--	<li class="nav-parent">
									...
									<li class="nav-parent">
										...
										<!--	<li>
											...
											<li class="nav-parent">
												<a href="userhotelsearch.php">Hotels</a>
											<!--	<ul class="nav nav-children">
													<li class="nav-parent">
														<a>Third Level</a>
														<ul class="nav nav-children">
...
$query="select * from book_room where id='$ti'";
...
while($row = mysqli_fetch_array($rs))
{
   ...
   <tr>
    ...
    <td><a href="#?id=<?php echo $row['id'];?>" style="color:green">VIEW</a>&nbsp; &nbsp;<a href="roomcancel.php?id=<?php echo $row['id'];?>" style="color:red">CANCEL</a></td>
    </tr>-->
    <?php
}
?>
