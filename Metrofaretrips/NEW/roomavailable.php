...
body, html {
  height: 100%;
  margin: 0;
  /* background-image:url("images1/img_1.jpg") */
}
</style>
<script>
        function finalCost(){
...
<!--<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  ...
  <div class="block-31" style="position: relative;">
    <div class="owl-carousel loop-block-31 ">
      <div class="block-30 item" style="background-image: url('images1/bg_2.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="block-30 item" style="background-image: url('images1/bg_1.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-10">
              <!-- <span class="subheading-sm">Welcome</span>
      ...
      <div class="block-30 item" style="background-image: url('images1/bg_3.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-10">
              <!-- <span class="subheading-sm">Welcome</span>
...
$i++;
	...
	//print_r($a);                 
      ...
      <tr>                  
												<td>	Room Type
                        <input type="text" name="roomtype" id="roomtype" value="<?php  echo $roomtype; ?>" readonly=""></td>

													<!--	<textarea rows="2" name="hname"> <?php //echo $name; ?></textarea>-->

														<!--<textarea rows="2" name="hid"> 	 <?php echo $id; ?></textarea>-->
                     <td>  check in
                          <input type="date" name="datefirst" id="datefirst" required="" value="<?php  echo $d1; ?>" readonly=""></td>
                        <td>  check out
                          <input type="date"  name="datesecond" id="datesecond" required="" value="<?php  echo $d2; ?>" readonly=""></td>
                          <!-- <p>Name</p>
