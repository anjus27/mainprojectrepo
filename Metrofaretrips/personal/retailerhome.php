			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li class="menu-has-children"><a href="">Add</a>
			            <ul>
			              <li><a href="blog-home.html">New Hotel</a></li>
			              <li><a href="blog-single.html">Edit Hotel</a></li>
						  
			            </ul>
			          </li>	
			          <li class="menu-has-children"><a href="">Bookings</a>
			            <ul>
		            	  <li><a href="elements.html">View booking</a></li>
				          <li class="menu-has-children"><a href="#">Confirm booking</a>
