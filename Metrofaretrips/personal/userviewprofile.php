 ...
 $sql    = "SELECT * FROM tbl_userreg WHERE lid='$lid'";
			...
			if(isset($_POST['edit']))
    {
       ...
       //$name=$_POST['firstname'];
        //$dob=$_POST['dob'];
		 $sql = "UPDATE `tbl_userreg` SET `firstname`='$n' ,`lastname` = '$lastname', `phone`='$phone', `gender`='$gender', `dob`='$dob',`housenumber`='$housenumber',`locality`='$locality',`district`='$district', `state`='$state', `email`='$email' WHERE lid='$lid'"; 
		 echo $sql;
