...
function Header()
{
    ...
    $this->Cell(80);
    // Title
    $this->Cell(30,10,'Booking Confirmation ',0,0,'C');
    // Line break
    $this->Ln(20);
}
...
$pdf->Cell(0,10,'',0,1);
$pdf->Cell(0,10,'',0,1);
$pdf->Cell(0,10,"                                      Roomtype             :     $roomtype",0,1);
$pdf->Cell(0,10,"                                      Checkin              :     $checkin",0,1);
$pdf->Cell(0,10,"                                      Checkout             :    $checkout",0,1);
$pdf->Cell(0,10,"                                      Wanted Rooms         :     $wantedrooms",0,1);
//for($i=1;$i<=40;$i++)
