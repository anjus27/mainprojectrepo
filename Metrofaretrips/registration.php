...
if(isset($_POST['submit']))
    {
        ...
        {
          $sql1="INSERT INTO `login`(`email`, `password`,`role`,`status`) VALUES ('$email','$password',1,1)";
          ...
          $lid="SELECT `lid` FROM `login` WHERE `email`='$email'";
           ...
           while($row=mysqli_fetch_array($result2))
           {
             ...
             $sql2="INSERT INTO `tbl_userreg`(`lid`,`firstname`,`email`,`password`,`status`) VALUES ($l,'$name','$email','$password',1)";
...
<script>   function emailDoesExist1() {
...
body {
  ...
  background: linear-gradient(to top, #1d1f1c,#066b04);
	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form  method="post"  >
					<input class="text  av-name" type="text" name="name"  av-message="Invalid name" placeholder="Name" required="">
          
					<input class="text email  av-email  verify-u" onblur="" type="email" name="email" av-message="Invalid email address" placeholder="Email" required="">
          <p id="p24" style="display:none">message</p>
					<input class="text av-password" type="password" name="password" av-message="Invalid password" placeholder="Password" required="">
