...
<head>
  ...
  <title>Lawride Lawyer - About us</title>
        ...
        <div class="container box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-end">
              ...
              <li class="nav-item"><a class="nav-link" href="index.php">Travel Informations</a>
  ...
  <section class="d-lg-flex align-items-center section-margin--large">
    ...
    <div class="container">
      <div class="about__content">
        <h3>Welcome To The Most Advanced Metro System In India</h3>
        <p>Our objective is to make Kochi the first city in the country where the entire public transport system: the metro, the buses, the boats, the auto-rickshaws and the taxies work together as a </p>
        <p>seamless integrated system; with a common timetable, common ticketing and centralised ‘command and control’..</p>
